...
INT_PTR CALLBACK dialog_proc (HWND window, UINT message, WPARAM wparam, LPARAM lparam)
{
  ...
  case WM_INITDIALOG:
    ...
    SetTimer (window_main_dialog, 1, 1000/60, NULL);
...
#else 
    MSG msg;
    HWND w=CreateDialogParam(instance, MAKEINTRESOURCE(IDD_DIALOG_MAIN), NULL, dialog_proc, NULL);
    window_main_dialog  = w;
